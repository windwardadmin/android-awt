...
import net.windward.android.imageio.spi.ImageReaderWriterSpi;
import net.windward.android.imageio.spi.ImageWriterSpi;
import net.windward.android.imageio.spi.ServiceRegistry;
