...
//
//    Map<TextAttribute, ?> mapInputMethodHighlightImpl(
//            InputMethodHighlight highlight) throws HeadlessException {
//        HashMap<TextAttribute, ?> map = new HashMap<TextAttribute, Object>();
//        wtk.getSystemProperties().mapInputMethodHighlight(highlight, map);
//        return Collections.<TextAttribute, Object> unmodifiableMap(map);
//    }
//
